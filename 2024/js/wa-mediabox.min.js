!(function () {
  ...
  (e.prototype.addImage = function (t, e) {
    ...
    (e.prototype.resizeContainer = function () {
      if (this.opened) {
        this.containerWidth || (this.containerWidth = Math.round(0.8 * this.overlay.offsetWidth)), this.containerHeight || (this.containerHeight = Math.round(0.8 * this.overlay.offsetWidth));
        var t = 160;
